#include "pch.h"
#include "CBloomUpScaling.h"

CBloomUpScaling::CBloomUpScaling()
	: CComputeShader(32, 1, 1)
{
	Create(L"shader\\stdBloom.fx", "CS_BloomUpScaling");
}
...
int CBloomUpScaling::UpdatePipeline()
{
...
void CBloomUpScaling::UpdateGroupCount()
{
