#include "pch.h"
#include "CBloomBluringY.h"

CBloomBluringY::CBloomBluringY()
	: CComputeShader(32, 1, 1)
{
	Create(L"shader\\stdBloom.fx", "CS_BloomBluringX");
}
...
int CBloomBluringY::UpdatePipeline()
{
...
void CBloomBluringY::UpdateGroupCount()
{
